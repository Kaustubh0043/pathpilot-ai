              ...
              {!isLogin && (
                ...
                <div className="flex items-start gap-3 mt-4 pt-1">
                  ...
                  <label htmlFor="agreeTerms" className="text-xs text-slate-400 leading-normal select-none">
                    I agree to the{' '}
                    <span className="text-purple-400 font-bold hover:text-purple-300 transition-colors cursor-pointer">Terms of Service</span>
                    {' '}and{' '}
                    <span className="text-purple-400 font-bold hover:text-purple-300 transition-colors cursor-pointer">Privacy Policy</span>.
                  </label>
                </div>
              )}
